  ...
  const graduatesDeclarationsHtml = isGraduates
    ? `
      <div class="section-block">
        ...
        <ul class="note-list">
            <li>Omani graduates (all disciplines): OR 3 only (ID card cost).</li>
            <li>Non-Omani Doctors (Clinical Attachment / Observership): OR 100 per month.</li>
            <li>Non-Omani Nurses and Allied Health Professionals (Clinical Attachment / Observership): OR 75 per month.</li>
            <li>Clinical students from private colleges and universities: OR 50 per week.</li>
